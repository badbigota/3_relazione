...
\begin{table}[h!]
    ...
    \begin{tabular}{|cc|c|c|c|c|}
        \hline
        &&$Int \pm \sigma_{Int}$&	$\langle Int \rangle \pm \sigma_{\langle Int \rangle}$&	$\lambda_{Int_{all}, Int_{acc.}}$&	$Err.\%$ \\
...
\begin{figure}[h!]
    ...
    \subfloat[Tabella]{
        \begin{tabular}{|c|c|c|}
                ...
                \si{[mm]}& $[\si{\micronnewton}]$ &$10^{-5}[\si{\micronnewton}]$ \\
                \hline
...
\begin{figure}[h!]
    ...
    \subfloat[Tabella]{
        \begin{tabular}{|c|c|c|}
                ...
                \hline
                {\cellcolor[rgb]{0.85,0.85,0.85}}$1.17$&{\cellcolor[rgb]{0.85,0.85,0.85}}	$58\pm2$& \multirow{3}{*}{$3.0\pm0.2$}\\
                $1.00$&	$50\pm2$&    \\
                {\cellcolor[rgb]{0.85,0.85,0.85}}$0.88$&{\cellcolor[rgb]{0.85,0.85,0.85}}	$48\pm1$&     \\    \cline{3-3}
                $1.37$&	$71\pm2$& \textbf{Intercetta}\\
                {\cellcolor[rgb]{0.85,0.85,0.85}}$1.41$&{\cellcolor[rgb]{0.85,0.85,0.85}}	$28\pm2$& $[\si{\micronnewton}]$\\\cline{3-3}
                $0.80$&   $37\pm1$&    \multirow{2}{*}{$17\pm2$}\\
                {\cellcolor[rgb]{0.85,0.85,0.85}}$1.64$&{\cellcolor[rgb]{0.85,0.85,0.85}}	$78\pm1$&        \\
                \hline
        \end{tabular}
